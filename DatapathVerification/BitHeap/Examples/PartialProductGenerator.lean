...
def bitHeapOfPartialProducts (width : Nat) : BitHeap (width * 2) := Id.run do
  let mut h := BitHeap.empty (width * 2)
  for i in [0:width] do
...
/--
info: {0 ↦ [b0], 1 ↦ [b1, b4], 2 ↦ [b2, b5, b8], 3 ↦ [b9, b6, b3, b12], 4 ↦ [b10, b13, b7], 5 ↦ [b11, b14], 6 ↦ [b15], 7 ↦ []}
-/
#guard_msgs in
