...
/--
info: (some {0 ↦ [b0], 1 ↦ [b1, b4], 2 ↦ [(b2 ⊕ b5), b8], 3 ↦ [((b3 ⊕ b12) ⊕ (b9 ⊕ b6)), (b2 ∧ b5)], 4 ↦ [((b3 ∧ b12) ∨ ((b3 ⊕ b12) ∧ (b9 ⊕ b6))), ((b7 ⊕ (b10 ⊕ b13)) ⊕ (b9 ∧ b6))], 5 ↦ [((b7 ∧ (b10 ⊕ b13)) ∨ ((b7 ⊕ (b10 ⊕ b13)) ∧ (b9 ∧ b6))), ((b14 ⊕ b11) ⊕ (b10 ∧ b13))], 6 ↦ [((b14 ∧ b11) ∨ ((b14 ⊕ b11) ∧ (b10 ∧ b13))), b15], 7 ↦ []})
-/
#guard_msgs in
