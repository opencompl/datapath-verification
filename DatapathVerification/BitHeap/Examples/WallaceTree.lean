...
/--
info: (some {0 ↦ [b0], 1 ↦ [(b1 ⊕ b4)], 2 ↦ [(((b2 ⊕ b5) ⊕ b8) ⊕ (b1 ∧ b4))], 3 ↦ [((((b9 ⊕ b6) ⊕ b3) ⊕ ((b2 ∧ b5) ∨ ((b2 ⊕ b5) ∧ b8))) ⊕ b12), (((b2 ⊕ b5) ⊕ b8) ∧ (b1 ∧ b4))], 4 ↦ [(((b9 ∧ b6) ∨ ((b9 ⊕ b6) ∧ b3)) ⊕ ((b10 ⊕ b13) ⊕ b7)), ((((b9 ⊕ b6) ⊕ b3) ∧ ((b2 ∧ b5) ∨ ((b2 ⊕ b5) ∧ b8))) ∨ ((((b9 ⊕ b6) ⊕ b3) ⊕ ((b2 ∧ b5) ∨ ((b2 ⊕ b5) ∧ b8))) ∧ b12))], 5 ↦ [((b11 ⊕ b14) ⊕ ((b10 ∧ b13) ∨ ((b10 ⊕ b13) ∧ b7))), (((b9 ∧ b6) ∨ ((b9 ⊕ b6) ∧ b3)) ∧ ((b10 ⊕ b13) ⊕ b7))], 6 ↦ [(b15 ⊕ (b11 ∧ b14)), ((b11 ⊕ b14) ∧ ((b10 ∧ b13) ∨ ((b10 ⊕ b13) ∧ b7)))], 7 ↦ [(b15 ∧ (b11 ∧ b14))]})
-/
#guard_msgs in
