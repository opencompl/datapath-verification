...
def applyHalfAdder (column : Nat) (i j : Circuit) (h : BitHeap) (acc : BitHeap) : (BitHeap × BitHeap × Adder) :=
...
def applyFullAdder (column : Nat) (i j k : Circuit) (h : BitHeap) (acc : BitHeap) : (BitHeap × BitHeap × Adder) :=
